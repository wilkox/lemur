...
openai_api_key <- function() {
  cli::cli_progress_step(
    "Retrieving OpenAI API key from {.envvar OPENAI_API_KEY} environmental variable...",
    msg_done = "Retrieved OpenAI API key from {.envvar OPENAI_API_KEY} environmental variable"
  )
